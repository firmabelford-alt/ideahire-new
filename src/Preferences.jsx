...
const EXACT_TRANSLATIONS = Object.freeze({
  ...
  "Odrzuć": "Reject",
  "Opinie": "Reviews",
  "Opinia po zakończeniu": "Review after completion",
  "Oceń wykonawcę": "Rate the contractor",
  "Opinię można wystawić tylko raz dla tej współpracy.": "You can submit only one review for this engagement.",
  "Twoja opinia": "Your review",
  "Wybierz ocenę": "Choose a rating",
  "Opublikuj opinię": "Publish review",
  "Publikowanie…": "Publishing…",
  "Opinia została opublikowana na profilu wykonawcy.": "The review has been published on the contractor's profile.",
  "Zweryfikowana opinia": "Verified review",
  "Zweryfikowane współprace": "Verified engagements",
  "Opinie zleceniodawców": "Client reviews",
  "Zweryfikowana opinia po zakończeniu współpracy": "Verified review after a completed engagement",
  "Ten wykonawca nie otrzymał jeszcze opinii po zakończonym zleceniu.": "This contractor has not received a review after a completed job yet.",
  "Opis": "Description",
  ...
  "Zlecenie zakończone": "Job completed",
  "Współpraca została zapisana jako wykonana na profilu wykonawcy.": "The engagement has been recorded as completed on the contractor's profile.",
  "Sprawdzanie opinii…": "Checking review…",
  "Zleceniodawca może teraz wystawić opinię na Twoim profilu.": "The client can now leave a review on your profile.",
